...
/home/qhuang/workspace/dpdk-2.2.0/tools/dpdk_nic_bind.py --bind=vfio-pci eth0
/home/qhuang/workspace/dpdk-2.2.0/tools/dpdk_nic_bind.py --status
...
### open switched
/usr/local/sbin/ovs-vswitchd --dpdk  -c 0x1 -n 4 --socket-mem 1024,0 -- unix:/usr/local/var/run/openvswitch/db.sock --pidfile --detach
